...
const ResizablePanelGroup = ({ className, ...props }: React.ComponentProps<typeof Panels.PanelGroup>) => (
  <Panels.PanelGroup
...
const ResizablePanel = Panels.Panel;

const ResizableHandle = ({
  withHandle,
  className,
  ...props
}: React.ComponentProps<typeof Panels.PanelResizeHandle> & { withHandle?: boolean }) => (
